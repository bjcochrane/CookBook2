...
The baking time and temperature given work well in the oven, however it came out rather dark in the toaster oven.  In the future, I'll try the settings for Honey Wheat Sandwich Bread - 375^o^ F. for 40-45 minutes.

### Ciabatta rolls

\newpage

### [Kaiser Rolls](https://www.sourdoughhome.com/sourdough-kaiser-rolls/){target="_blank"}
...
2.  Divide the dough into two equal pieces with your bench knife, and
    flour the surfaces of each. Fold over the cut side of each so that there is a smooth floured circle on the top.
...
5.  For each loaf, perform the following folds: 
...
the oven to create steam - the method in the original recipe. 
...
250 gm. water (75-80^o^ F.)\
375 gm. all purpose flour\
175 gm. bread flour\
5 gm. salt

1.  Combine leaven, poolish, water, and both flours in bowl of
...
3.  Let the dough rise in a warm place, gently folding every 40 minutes,
    until the dough becomes puffy and springy (3-4 hours).  Alternatively, let the dough rise for 90 minutes and then refrigerate overnight.
...
1.  Place the dough on a lightly floured surface and divide first into
    three equal pieces, each of which is divided three ways. 
...
3.  Place the pan onto the baking stone in the oven, with a cookie sheet between the pan and the stone.   Lower the
    temperature to 475^o^ F. and bake for 30 minutes.
4.  Remove the foil and continue to bake for another 10-15 minutes,
    until the loves are a rich golden brown.
5.  Wrap the loaves in clean kitchen towels and place on a cooling rack.

<center>

![](images/baguettes-final.jpeg){width="60%"}

The final product. In this case, a double recipe was prepared andthe dough was divided into eight loaves.
All were baked on a pizza steel (method 1) on the same day.

</center>

### [Sourdough Brioche Buns](https://veenaazmanov.com/sourdough-brioche-buns/){target="_blank"}

In my seemingly eternal quest for decent homemade burger buns, this sounds like a recipe worth trying.  As an alternative, here is a [simpler recipe](https://veenaazmanov.com/sourdough-hamburger-buns){target="_blank"}.  The main difference is less butter and sugar (probably a good thing, dietarily speaking).
