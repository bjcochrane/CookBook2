...
3. For [Essential Tartine Bread](#tartines), **proofing baskets** are a must.  I use oval ones, which were used to shape the loaves shown above.  
...
4. A **pizza stone or steel** is useful for baking rolls and freestanding loaves in addition to pizza.  Do get a heavy duty one - the more inexpensive round ones sold at grocery and department stores do not stand up to the high heat used in some of these recipes.  
5.  For making [essential tartine bread](#tartines) you will need a dutch oven or an oven roaster, one which can be inverted for cooking.
6.  You will need to cut the dough with a knife during the shaping process.  If you have a large (8-10 inch) chef's knife, that will work fine, however a **bench knife** is useful not only for cutting but also for manipulating dough pieces.  We already had a **pizza knife** that serves these purposes well.

## Grilling

Of course, you will need the **basic grilling tools** - spatula, fork, tongs and heavy oven mitts. And a cleaning brush.  Beyond those I would recommend a **grilling basket** and a **fish grilling mesh**.  In both cases, be sure you get ones with removable handles, since they won't fit inside a closed Green Egg with the handles on.  An example of a grilling basket is [this one from Williams Sonoma](https://www.williams-sonoma.com/products/outset-chefs-outdoor-grill-basket-skillet-handles/).
