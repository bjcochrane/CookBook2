...
1. Slice the vegetables and add the remaining seasoning.
...
2.  Add the shallot, garlic, paprika and red pepper.  Simmer 2 minutes
3. Place the shrimp on skewers (3-4 shrimp on each) and brush liberally with the butter mixture.
4. Grill for a total of four minutes, surning once.  The shimp should now have a pinkish tinge.
5. Serve over pasta, with any remaining butter mix mixed in.  Squeeze 2 lemon quarters over each serving.
