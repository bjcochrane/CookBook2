...
### Chicken Fajitas/Tacos<sup>*</sup>

This is an untested recipe from New York Times commentator Jamelle Bouie.  He recommends adding guacamole to the final product; do so according to your taste.
...
7.  Add guacomle and/or sautéd vegetables to the tortillas and cover with chicken strips for serving.

<sup>*</sup>As an alternative to this recipe, I'm sure that  the recipe for [Beef Fajitas](#beeffajitas) would work as well, only the chicken would be sliced prior to seasoning and cooking, and grilling would be in a basket.
...
4.  When the internal temperature reaches 180 ^o^ F., glaze the wings with a 2:1  mixture of barbecue sauce and syrup.^\*\*^
5.  Continue cooking until the internal temperature reaches 195^o^ F.  Remove and serve.
...
2.  Wrap with foil or butcher paper and continue cooking, increasing the grill temperture to 275^o^ F., until internal temperature reaches 180^o^ F.
3.  Unwrap, baste thoroughly with sauce mixture, and continue cooking until the internal temperature reaches 195^o^ F.  You may want to baste it once or twice more during this time.
