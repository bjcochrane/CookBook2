...
### Chicken Fajitas/Tacos{#chfajitas}
...
As an alternative to this recipe, I'm sure that  the recipe for [Beef Fajitas](#beeffajitas) would work as well, only the chicken would be sliced prior to seasoning and cooking, and grilling would be in a basket.
...
I agree with Bubba in *Forrest Gump* - you can do just about anything with shrimp. Furthermore, they can be cooked easily and rapidly (the big danger is overcooking). As for grilling, there are lots of possibilities - [allrecipes.com](https://www.allrecipes.com/gallery/best-grilled-shrimp-recipes/) provides 18 recipes for doing so. Thermoworks has a [post](https://blog.thermoworks.com/fish-seafood/grilled-shrimp-skewers) that goes through the grilling process in detail.

Here's the recipe I've settled on.  You may also want to try [shrimp wrapped in Serrano ham](#spshrimp) described elsewhere.
...
1.  Light your grill and bring it to about 350^o^ F.
...
6.  Grill for about four minutes, turning at least once. The desired internal temperature is 120^o^ F.  
...
### [Elk Burger](https://blog.thermoworks.com/beef/grilled-elk-burgers/){target="_blank"}
...
But how does one do indirect cooking on a Green Egg?  A little searching on Amazon led me to [this device](https://www.amazon.com/dp/B07THJG18S?psc=1&ref=ppx_yo2ov_dt_b_product_details){target="_blank"}. It's a bit pricey, but it works like a charm for the purpose.  It also results in improved air circulation and thus cleaner burning charcoal.

<center>
![](./images/BGEDivided.jpeg){width=50%}
...
1.  Load charcoal in one side of the divider and ignite.  When they are burning, close the lid and monitor the temparture until it reaches 450^o^ F.
2.  While the charcoal is igniting, apply salt and pepper to the patties to taste.  I found that lots of pepper and just a little salt works well.
3.  If necessary, slice the rolls in half.
4.  Insert a needle probe  into the side of one of the burgers.  Place them on the indirect cooking side of the Green Egg and close the lid.
5.  When the internal temperature reaches 120^o^ F, switch them to the direct side, and place the rolls on the indirect side, face down.
6.  Grill the burgers, flipping every 40 seconds or so, until the internal temperature reaches 160^o^ F, monitoring with a handheld probe.  This takes about 2-3 minutes.
7.  When they are done, check the rolls - they should be lightly toasted.
8.  If using cheese, return the burgers to the indirect side when they reach 150^o^ F. and let them stand until the cheese is melted.  
9.  Apply your favorite toppings and eat!
Ready to eat.
...
So the predominant advice on most barbecue recipes is "low and slow".  This makes sense, since the original Caribbean *barbacoa" was performed in a charcoal filled pit in the ground.  More importantly, it gives time for the meat to take up the smoke flavor.  Accordingly, most of the recipes here call for maintaining a temperature between 200 and 250^o^ F.  But of course that also means that cook times can be quite long - as much as 18 hours for a packer brisket or a full Boston butt roast.  So plan ahead!

With that in mind, here are a few points to consider:

1.  You've put  your internal temperature monitor into your brisket or butt, the grill temperature is stable, and the internal temperature is rising steadily.  UNTIL it reaches 160 or so.  Then it just sits there, possibly for hours.  This is the infamous "stall" that occurs when liquid in the meat starts evaporating, causing evaporative cooling.  At that point, you have two choices - either wait it out, or wrap the meat in foil or "peach paper", essentially unwaxed butcher paper.  I prefer the latter for a couple of reasons.  First of all, at this point the meat has absorbed all of the smoke it's going to.  Second, the meat is less likely to dry out as it rises to the magic end point of 203^o^ F.  And, of course, it saves time
2.  Even if you are cooking for a large family, it is doubtful that a full packer brisket will be devoured on the first sitting.  So how to reheat leftovers?  Thermoworks [recommends a *sous vide* approach](https://blog.thermoworks.com/thermometer/how-to-reheat-bbq/){target="_blank"}, in which frozen leftover barbecue is placed in a ziploc bag and immersed in a water bath maintained at 175^o^ F. until the internal temperature reaches 165^o^ F.  This something that can easily be done with a *sous vide* wand or an InstantPot®, but the link above describes how it can be accomplished with a pot of water on the stove top.
...
> Peach paper (available at [Lowes](http://www.lowes.com))
...
### Candied Ribs/Pork Wings

This recipe comes from [Thermoworks](https://blog.thermoworks.com/pork/wide-cut-pork-ribs-recipe) And calls for "wide ribs" - basically St. Louis ribs cut into two rib sections.  It occurs to me, however, that it would also work well with pig wings.  The recipe below uses "wings"; the original post describes how to process ribs.
...
2.  Set up your smoker to a temperature of 225^o^ F. 
3.  Place the wings in the smoker with a needle probe in one and a grill temperature monitor in place.
4.  When the internal temperature reaches 200^o^ F., glaze the wings with a 2:1  mixture of barbecue sauce and syrup.^\*\*^
5.  Continue cooking for an additional hour, turning and basting occasionally.  Remove and serve.

^\*^  This is a commercial product available from multiple online sources, including [this one](https://www.thebbqsuperstore.com/product_p/tp-sce-a05.htm).

^\*\*^having now cooked this once, I would modify it along the lines of [3-2-1 ribs](#ribs),as follows

1.  Hook over indirect heat until the internal temperature reaches about 150^o^ F.
2.  Wrap with foil or butcher paper and continue cooking, increasing the grill temperture to 275^o^ F., until internal temperature reaches 195-200^o^ F.
...
Of course there are lots of other styles of wing sauce.  One that I like is [Korean barbecue ribs](https://www.southernliving.com/recipes/spicy-grilled-chicken-wings)  published recently in *Southern Living*:
...
Still looking for ideas?  Check out this [compendium of wing recipes](https://www.epicurious.com/recipes-menus/our-best-chicken-wing-recipes-gallery) from Epicurious.
...
This recipe, from [Hey Grill Hey](https://heygrillhey.com/smoked-duck/#wprm-recipe-container-10552) is relatively straightforward to prepare, and if cooked on a charcoal grill, is excellent.  Note that I did try it once in the oven (weather was too bad for outdoor cooking, even for me) and the results were, to put it mildly, disappointing
...
2.  Prepare your grill for smoking (with convEGGtor) at 275^o^ F., using apple chunks for smoke.
...
4.  Smoke the duck to an internal temperature of 160^o^ F., a time of about 2.5 hours, basting periodically with  the combined orange juice and maple syrup.  The probe should be inserted  into the breast.
...
Even if the grill temperature does drift upwards, as long as you monitor the internal temperature and pull the fish when it hits 135^o^ F., you will have an excellent piece of fish to share with friends.  
...
8.  When the internal temperature reaches 135^o^ F., remove the fish to a platter and let it cool.
